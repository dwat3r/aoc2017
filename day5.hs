...
go' c i code = do 
  ...
  if (i < min || i >= max) then return c
    ...
    v <- readArray code i
    writeArray code i (if v > 2 then v - 1 else v + 1)
    go' (c + 1) (i + v) code
